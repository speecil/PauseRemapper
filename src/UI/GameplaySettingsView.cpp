...
#define SetPreferredSize(identifier, width, height)                                         \
    ...
    fitter##identifier->set_verticalFit(                                                    \
        ContentSizeFitter::FitMode::PreferredSize);                                         \
    fitter##identifier->set_horizontalFit(                                                  \
        ContentSizeFitter::FitMode::PreferredSize)
...
void PauseRemapper::UI::GameplaySettingsView::DidActivate(
    bool firstActivation)
{
    ...
    text3 = QuestUI::BeatSaberUI::CreateText(vertical->get_transform(),
        "Change your pause button here!");
    ...
    QuestUI::BeatSaberUI::CreateDropdown(
        vertical, getMainConfig().Button.GetName(),
        getMainConfig().Button.GetValue(),
        { "Default", "A Button", "B Button", "X Button", "Y Button",
            "Left Trigger", "Right Trigger", "Left Grip", "Right Grip",
            "Click Left Thumbstick", "Click Right Thumbstick" },
        [](StringW value) {
    ...
    QuestUI::BeatSaberUI::CreateDropdown(
        vertical, getMainConfig().Button2.GetName(),
        getMainConfig().Button2.GetValue(),
        { "Default", "A Button", "B Button", "X Button", "Y Button",
            "Left Trigger", "Right Trigger", "Left Grip", "Right Grip",
            "Click Left Thumbstick", "Click Right Thumbstick" },
        [](StringW value2) {
    ...
    text4 = QuestUI::BeatSaberUI::CreateText(
        vertical->get_transform(),
        "Message speecil#5350 on discord if there are any issues");
    text4->set_alignment(TMPro::TextAlignmentOptions::Center);
    text4->set_fontStyle(TMPro::FontStyles::Normal);
    space2 = QuestUI::BeatSaberUI::CreateText(vertical->get_transform(), "\n \n ");
    text2 = QuestUI::BeatSaberUI::CreateText(
        vertical->get_transform(),
        "Subscribe to my patreon for pre-release mods!");
    text2->set_alignment(TMPro::TextAlignmentOptions::Center);
    text2->set_fontStyle(TMPro::FontStyles::Normal);

    BeatSaberUI::CreateUIButton(vertical->get_transform(), "Patreon",
        "PlayButton", UnityEngine::Vector2(),
        UnityEngine::Vector2(6.0f, 11.3f), test);

    text5 = QuestUI::BeatSaberUI::CreateText(
        vertical->get_transform(), "Pause Remapper v0.3.0_DEV by Speecil");
    ...
    // AddConfigValueToggle(vertical->get_transform(),
    // getMainConfig().EnableResume);
}
